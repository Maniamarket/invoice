<?php $this->pageTitle = Yii::app()->name . ' - ' . Yii::t('mypurse', 'My Purse') . ": " . Yii::t('mypurse', 'Transfer Money') ." ". Yii::t('mypurse', 'Confirm the transfer'); ?>
...
<div class="block_title">
    <h1><?php print Yii::t('mypurse', 'My Purse') . " &raquo; " . Yii::t('mypurse', 'Transfer Money') . " &raquo; " . Yii::t('mypurse', 'Confirm the transfer'); ?></h1>
</div>
<div class="cl"></div>
...
<div class="mypurse">
    ...
    <div class="form full">
        ...
        <div class="row buttons">
            ...
            <?php echo CHtml::submitButton(Yii::t('mypurse', 'Confirm the transfer'), array('class' => 'submit')); ?>
        </div>
        <div class="cl"></div>
