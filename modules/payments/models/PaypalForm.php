...
class PaypalForm extends Model {
    ...
    CONST TEST_BUSINES_PAYPAL_EMAIl = 'https://www.sandbox.paypal.com/cgi-bin/webscr';
    CONST LIFE_BUSINES_PAYPAL_EMAIl = 'https://www.sandbox.paypal.com/cgi-bin/webscr';
