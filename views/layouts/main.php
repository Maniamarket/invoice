            ...
            echo NavX::widget([
                ...
                'items' => [
                    ...
                    ['label' => Yii::t('app', 'Users'), 'url' => '#', 'visible' => Yii::$app->user->can('manager'),
                        'items' => [
                            ['label' => Yii::t('app', 'My Users'), 'url' => ['/user/index', 'type_user' => 1], 'visible' => (Yii::$app->user->can('manager') && !Yii::$app->user->can('superadmin'))],
                            ...
                            ['label' => Yii::t('app', 'Profit'), 'url' => ['/user/profit'], 'visible' => Yii::$app->user->can('manager')],
                        ],
                    ],
...
//							],
                            ...
                            ['label' => Yii::t('app', 'Transactions Receipt'), 'url' => ['/transactionbanktrans/receipt'], 'visible' => !Yii::$app->user->isGuest],
                        ],
                    ],
