...
$view_element = 'vat_id'.$model->id;
$view_element_td = 'td_vat_id'.$model->id;
?>
...
<tr id="<?php echo Html::encode($view_element); ?>">
    ...
    <td>
       <?php 
            $url = Url::toRoute(['vat/update','id'=>$model->id]);
            echo Html::a('save',Url::toRoute(['vat/update','id'=>$model->id]),
            [
